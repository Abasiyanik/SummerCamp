...
public class HumanResource {
    ...
    static Employee employee1;// they are static so called from class nane.
   ...
   // employee1=new Employee();// bu calismaz
   // employee1.setEmployeeInfo();

    static{// as sson as th class caleed, the static variables need to be set
